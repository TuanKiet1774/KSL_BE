 ...
 * @param {string} otp - Mã OTP 6 chữ số
 */
const sendPasswordResetOTPEmail = async (toEmail, fullname, otp) => {
    const transporter = createTransporter();

    const info = await transporter.sendMail({
        from: `"KSL App" <${process.env.GMAIL_USER}>`,
        to: toEmail,
        subject: "Đổi mật khẩu KSL - Mã OTP xác nhận",
        html: `
        <!DOCTYPE html>
        <html lang="vi">
        <head>
                ...
                <tr>
                    <td align="center">
                        <table width="560" cellpadding="0" cellspacing="0" style="background:linear-gradient(145deg,#1a1a2e,#16213e);border-radius:20px;overflow:hidden;border:1px solid #2d2d5f;">
                            <!-- Header -->
                            <tr>
                                <td style="background:linear-gradient(135deg,#e53e3e,#dd6b20);padding:36px 40px;text-align:center;">
                                    <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:700;letter-spacing:2px;">KSL</h1>
                                    <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:13px;letter-spacing:1px;text-transform:uppercase;">Kiet's Sign Language</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding:40px 40px 30px;">
                                    ...
                                    <p style="margin:0 0 24px;color:#a0aec0;font-size:15px;line-height:1.7;">
                                        Chúng tôi nhận được yêu cầu <strong style="color:#e53e3e;">đổi mật khẩu</strong> cho tài khoản <strong style="color:#667eea;">KSL App</strong> của bạn.<br/>
                                        Sử dụng mã OTP bên dưới để xác nhận việc đổi mật khẩu.
                                    </p>

                                    <!-- OTP Box -->
                                    <div style="text-align:center;margin:30px 0;">
                                        <div style="display:inline-block;background:linear-gradient(135deg,#e53e3e22,#dd6b2022);border:2px solid #e53e3e;border-radius:16px;padding:24px 40px;">
                                            <p style="margin:0 0 6px;color:#a0aec0;font-size:12px;letter-spacing:2px;text-transform:uppercase;">Mã xác nhận</p>
                                            <span style="font-size:42px;font-weight:800;letter-spacing:10px;color:#ffffff;font-family:'Courier New',monospace;">${otp}</span>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Warning -->
                                    <div style="background:#1e1e3a;border-left:4px solid #e53e3e;border-radius:8px;padding:16px 20px;margin-bottom:24px;">
                                        <p style="margin:0;color:#fc8181;font-size:13px;">
                                            ⏱ Mã OTP có hiệu lực trong <strong>10 phút</strong>. Vui lòng không chia sẻ mã này với bất kỳ ai.
                                        </p>
                                    </div>

                                    <p style="margin:0;color:#718096;font-size:13px;line-height:1.7;">
                                        Nếu bạn không thực hiện yêu cầu đổi mật khẩu này, vui lòng bỏ qua email này hoặc liên hệ hỗ trợ ngay lập tức.
                                    </p>
                                </td>
                            </tr>
...
module.exports = { generateOTP, sendOTPEmail, sendPasswordResetOTPEmail };
